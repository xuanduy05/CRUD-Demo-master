...
//    String url = "http://192.168.1.9/demoandroid/retrieve.php";
    String url = "http://192.168.43.36:8081/demoandroid/retrieve.php";
    Employee employee;
    @Override
...
//        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.1.9/demoandroid//delete.php",
                StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.43.36:8081/demoandroid/delete.php",
